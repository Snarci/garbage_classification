function [] = extract_and_save(onGpu,n_clusters,max_iter_k_means,need_to_extract_features,number_of_bins,size_patch)
...
if need_to_extract_features
   train_table = features_extraction_dense(train_set,size_patch);
   test_table = features_extraction_dense(test_set,size_patch);
end
...
endpath=strcat("n_clusters_",num2str(n_clusters),"_number_of_bins_",num2str(number_of_bins),"_grid_size_",num2str(size_patch));
path_train=strcat("E:\CV\garbage_classification/computate_di_notte/dense/train/table_",endpath);
path_test=strcat("E:\CV\garbage_classification/computate_di_notte/dense/test/table_",endpath);
